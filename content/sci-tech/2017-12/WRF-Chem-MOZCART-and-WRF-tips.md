...
1. Run real.exe (chem_opt=0) to generate wrfinput_d0*and wrfbdy_d01;

2. Generate **FINN** fire-emissions following the README.WRF.fire;
...
6. Link all these emission files to the 'em_real' directory;

7. Change chem_opt=112 and run real.exe again.

8. Create lateral boundary and initial conditions from a global chemistry model NCAR/ACOM. Download required files of **mozbc** from https://www2.acom.ucar.edu/wrf-chem/wrf-chem-tools-community.
...
/
```
9. copy modfied wrfinput* and wrfbdy_d01 to 'em_real' directory
10. Run wrf.exe